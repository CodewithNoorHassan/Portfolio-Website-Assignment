        ...
        <div>
            ...
            <div>
                <a className="flex justify-center border mt-3 w-[700px] mx-auto rounded-lg shadow-lg">
                    <img className="max-w-full rounded-t-lg w-96 mt-2" src="/Suzuki_Alto.png" alt="image" />
                </a>
            </div>
            ...
            <div className="bg-white mt-4 border mx-auto w-[700px] text-center dark:bg-slate-900 rounded-lg px-6 py-8 ring-1 ring-slate-900/5 shadow-lg">
                <h3 className="text-slate-900 dark:text-white text-base font-bold tracking-tight">Suzuki Alto one of the most popular Car in Pakistan</h3>
